...
| 顺序 | 计划                                                       | 规格                                                  | 交付                    | 状态   |
| ---- | ---------------------------------------------------------- | ----------------------------------------------------- | ----------------------- | ------ |
| 1    | [m1-merge-workspace](./2026-08-18-m1-merge-workspace.md)   | [spec](../../specs/2026-08-18-m1-merge-workspace.md)  | store + 导入/导出纯函数 | 已完成 |
| 2    | [m2-two-way-editor](./2026-08-18-m2-two-way-editor.md)     | [spec](../../specs/2026-08-18-m2-two-way-editor.md)   | `TwoWayMergeEditor`     | 已完成 |
| 3    | [m3-home-import](./2026-08-18-m3-home-import.md)           | [spec](../../specs/2026-08-18-m3-home-import.md)      | ImportBar + HomeView    | 已完成 |
| 4    | [m4-remove-legacy-ui](./2026-08-18-m4-remove-legacy-ui.md) | [spec](../../specs/2026-08-18-m4-remove-legacy-ui.md) | 删死 UI + sync          | 已完成 |
