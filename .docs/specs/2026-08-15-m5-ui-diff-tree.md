...
Diff 树展示与选边交互的增量（CM 展开对比、radio 选边、两列空态、树与 side 解耦）见  
[2026-08-17 Diff/Result JSON 规格](./2026-08-17-diff-result-json-viewer.md)。本 M5 文档保留切片当时的验收边界，不以历史描述覆盖当前 UI。
