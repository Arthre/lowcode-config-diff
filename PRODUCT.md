...
- **绑定视觉约束（用户确认）：** 冷灰画布；亮色中天蓝、暗色静谧青绿强调的 AI 原生工具感；拒绝默认紫渐变 / Vite 模板紫 accent；Operate 优先扫读与语义色，不做营销仪表盘堆砌
